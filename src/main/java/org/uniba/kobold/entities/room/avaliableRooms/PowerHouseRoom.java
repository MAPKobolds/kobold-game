...
public final class PowerHouseRoom extends Room {
    ...
    public PowerHouseRoom() {
        super("generatore",
                "L'edificio contenente il generatore è il più pulito e ordinato di questo inferno.\nSu tutte le pareti sono stati piazzati dei motori di autovetture " +
        ...
        switch (command.getCommand().getName()) {
            ...
            case "parla direttore":
                result.setSubject("Il coboldo direttore ti guarda e ti dice: 'Non hai niente da fare qui, vai via!' \n" +
                        "vedi però che sul suo pc sta cercando da oltre 10 minuti di risolvere dei quiz di film \nsarebbe meglio che lo "
