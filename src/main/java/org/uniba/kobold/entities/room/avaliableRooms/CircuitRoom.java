...
public final class CircuitRoom extends Room {
    ...
    public RoomInteractionResult executeCommand(ParserOutput command, Inventory inventory) {
        ...
        switch (command.getCommand().getName()) {
            case "guarda giu":
                result.setSubject("Guardi giù e vedi il pavimento, è sporco e pieno di cicche di sigarette ,però noti qualcosa di interessante, un fogio con scritto 2 sopra.");
                break;
            case "guarda davanti":
